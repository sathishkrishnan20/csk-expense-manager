...
const GoogleLoginButton = ({onClickLogin, isLoading}: HeaderProps) => {
  return (
    <button onClick={() => onClickLogin()} disabled={isLoading} className="gsi-material-button">
...
export const Header = ({ isLoading, onClickLogin }: HeaderProps) => {
  return (
