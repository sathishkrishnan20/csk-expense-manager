...
export const TRANSACTION_COLUMNS_ORDERS: (keyof ExpenseSchema)[] = [
  'RowId',
  'Category',
  'SubCategory',
  'Payee',
...
export const CATEGORY_SUBCATEGORY_TAB_HEADERS: (keyof CategorySubCategorySchema)[] = [
  'RowId',
  'CategoryName',
  'SubCategoryName',
  'Timestamp',
...
export const PAYMENT_METHOD_TAB_HEADERS: (keyof PaymentMethodsSchema)[] = [
  'RowId',
  'PaymentMethodName',
  'Timestamp',
  'Status',
