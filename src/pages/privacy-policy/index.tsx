  ...
  return (
    <Box sx={{ pb: 7 }} ref={ref}>
      ...
      <Paper style={{ padding: 16 }} elevation={0}>
        ...
        <p>
          The App uses Google's Basic Personal Identifier, including the user's name and profile picture. This
          information is used solely for the purpose of personalization within the App and is not shared with any third
          parties.
        </p>
