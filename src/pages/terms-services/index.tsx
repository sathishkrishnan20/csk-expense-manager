  ...
  return (
    <Box sx={{ pb: 7 }} ref={ref}>
      ...
      <Paper style={{ padding: 16 }} elevation={0}>
        ...
        <p>
          To use certain features of the App, you may be required to create a user account. You are responsible for
        ...
        <p>
          We reserve the right to modify these terms of service at any time. You are advised to review this page
          periodically for any changes. Your continued use of the App after the changes constitute your acceptance of
          the new terms.
        </p>
        ...
        <p>
          We may terminate or suspend access to our App immediately, without prior notice or liability, for any reason
